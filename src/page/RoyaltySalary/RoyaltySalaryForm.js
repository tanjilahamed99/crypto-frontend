        ...
        <div className="bg-opacity-20 bg-gray-400">
          <div className="rounded-lg  text-card-foreground shadow-sm p-2 bg-transparent w-full">
            ...
            <div className="p-6 pt-0 flex flex-col md:flex-row gap-4 items-center md:items-stretch">
              <Link
                href={`/dashboard/royaltySalary/myRoyaltySalery?type=millionaire`}
                className="rounded-lg text-card-foreground shadow-sm p-2 w-full max-w-sm transform  transition-transform duration-100 hover:scale-105 bg-gray-400 bg-opacity-20 hover:bg-gray-600 py-10"
              >
