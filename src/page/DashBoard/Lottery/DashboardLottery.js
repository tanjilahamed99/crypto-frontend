      ...
      <div className="rounded-lg gap-1 shadow-sm p-4 bg-opacity-20 bg-gray-400 w-full">
        ...
        <div className="mt-3">
          <div className="hidden md:inline">
            <LotterySlider view={2} />
          </div>
          <div className=" md:hidden">
            <LotterySlider view={1} />
          </div>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col md:flex-row p-4 justify-between items-start md:items-center border text-card-foreground w-full mt-2 bg-opacity-20 bg-gray-400 shadow-lg rounded-lg transform transition-transform duration-100 hover:scale-105 hover:bg-gray-600 hover:border-indigo-700 gap-5 md:gap-0">
            <div>
              <div className="text-white md:text-lg flex items-center font-semibold gap-2 md:gap-5">
                <h2 className="flex items-center">
                  Entry fee: <span className="text-green-500 ml-2 mr-1">$</span>
                  10
                </h2>
              ...
              <div className="text-white md:text-lg flex items-center font-semibold md:gap-5 gap-2 my-2 md:mt-2 md:mb-6">
                <h2 className="flex items-center">
                  Perticipants:{" "}
                  <span className="text-green-500 ml-2 mr-1">9081</span>10000
                </h2>
                <button className="text-lg font-semibold bg-primary text-white rounded-xl px-3 py-1 hover:bg-green-700">
                  view
                </button>
